// Auto-generated component loader (VN version) - do not edit manually
const headerNavHTML = `<header class="ys-header">
                ...
                <div class="head1-fr">
                    <ul class="head1-inof">
                        ...
                        <li class="head1-inof-nub ">
                            <a href="about-us.html" target="_self" class="head1-inof-nub-link">Về Chúng Tôi</a>
                        </li><!-- 选中添加类名active-->
                        <li class="head1-inof-nub ">
                            <a href="news-media/news-center/news.html" target="_self" class="head1-inof-nub-link">Tin Tức & Truyền Thông</a>
                        </li><!-- 选中添加类名active-->
                        <li class="head1-inof-nub ">
                            <a href="news-media/blogs.html" target="_self" class="head1-inof-nub-link">Blog</a>
                        </li><!-- 选中添加类名active-->
                        <li class="head1-inof-nub ">
                            <a href="news-media/events.html" target="_self" class="head1-inof-nub-link">Sự Kiện</a>
                        </li><!-- 选中添加类名active-->
                        <li class="head1-inof-nub ">
                            <a href="contact-us.html" target="_self" class="head1-inof-nub-link">Liên Hệ</a>
                        </li>                    </ul>
                        ...
                        <div class="yx-search3xlbox">
                            <div class="yx-search3-tbox clearfix">
                                <div class="yx-search3-xls fl">
                                    <input type="text" placeholder="Vui lòng nhập..." id="keywords">
                                </div>
                        ...
                        <li class="head-nav-item ">
                            <div class="head-nav-item-nub">
                                ...
                                <div class="head-nav-item-down head-pull-second">
                                    ...
                                    </div>                                                            </div><li class="head-nav-item ">
                            <div class="head-nav-item-nub">
                                <a href="#"  class="head-nav-item-title">Kênh đối tác</a>
                                                                                                <!-- 下拉类型三 -->
                            ...
                            <div class="head-nav-item-nub">
                                <a href="#"  class="head-nav-item-title">Hỗ Trợ</a>
                                                                                                <!-- 下拉类型三 -->
                                    <div class="head-nav-item-down head-pull-third">
                                        <div class="head-pull-third-cont ys-cont1600">
                                            <ul class="head-pull-third-ul">
                                                <!-- 二级选中添加类名yxnav-active2 act -->
                                                 <li class="hptu-li ">
                                                    <a href="#"  title="" class="hptu-li-link">
                                                        <div class="hptu-li-le">
                                                            <div class="hptu-li-le-icon">
                                                                <img src="Public/En/images/a1_icon_08.svg" alt="a1_icon_08.svg">
                                                            </div>
                                                            <p>Hỏi AI</p>
                                                        </div>
                                                        <div class="hptu-li-ri-icon">
                                                    ...
                                                    <a href="#"  title="" class="hptu-li-link">
                                                        <div class="hptu-li-le">
                                                            <div class="hptu-li-le-icon">
                                                                <img src="Public/Uploads/uploadfile/images/20250901/xiala03.svg" alt="xiala03.svg">
                                                            </div>
                                                    ...
                                                    <a href="#"  title="" class="hptu-li-link">
                                                        <div class="hptu-li-le">
                                                            <div class="hptu-li-le-icon">
                                                                <img src="Public/Uploads/uploadfile/images/20250901/icon08.svg" alt="icon08.svg">
                                                            </div>
                                                            <p>Wiki</p>
                                                        </div>
                                                        <div class="hptu-li-ri-icon">
                            ...
                            <div class="ys-modal-container">
                                <div class="ys-modal-content">
                                    <div class="ys-phnavss-form">
                                        <input type="text" placeholder="Vui lòng nhập..." id="phkeywords">
                                        <button type="button" onclick="phsearch()">Tìm Kiếm</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="ys-phmenu-scroll">
                    <ul class="ys-ph-nav">
                        ...
                        <li class="ys-phnav-haschild ">
                            <div class="ys-phnav-lisbox">
                                <a href="#" >
                                    <div class="ys-phnav-header-font">Dân Dụng</div>
                                </a>
                        ...
                        <li class="ys-phnav-haschild ">
                            ...
                            <ul>
                                <li class=" ">
                                    <div class="ys-phnav-lisbox">
                                        <a href="#" >
                                            <div class="ys-phnav-header-font">Hỏi AI</div>
                                        </a>
                                        <div class="ys-phnav-icon"></div>
                                    </div>
                                                                    </li><li class=" ">
                                    <div class="ys-phnav-lisbox">
                                        <a href="#" >
                                            <div class="ys-phnav-header-font">Câu Hỏi Thường Gặp</div>
                                        </a>
                                        <div class="ys-phnav-icon"></div>
                                    </div>
                                                                    </li><li class=" ">
                            ...
                            <div class="ys-phnav-lisbox">
                                <a href="contact-us.html" >
                                    <div class="ys-phnav-header-font">Liên Hệ</div>
                                </a>
                                <div class="ys-phnav-icon"></div>
                            </div>
                         ...
                         <li class="">
                            <div class="ys-phnav-lisbox">
                                <a href="about-us.html" target="_self">
                                    <div class="ys-phnav-header-font">Về Chúng Tôi</div>
                                </a>
                                <div class="ys-phnav-icon"></div>
                            </div>
                        </li><li class="">
                            <div class="ys-phnav-lisbox">
                                <a href="news-media/news-center/news.html" target="_self">
                                    <div class="ys-phnav-header-font">Tin Tức & Truyền Thông</div>
                                </a>
                                <div class="ys-phnav-icon"></div>
                            </div>
                        </li><li class="">
                            ...
                            <div class="ys-phnav-lisbox">
                                <a href="news-media/events.html" target="_self">
                                    <div class="ys-phnav-header-font">Sự Kiện</div>
                                </a>
                                <div class="ys-phnav-icon"></div>
                            </div>
                        </li>
                    ...
                    <div class="ys-phnav3-language">
                        <div class="ys-phnav3-lang-hd ys-phnav-lisbox">
                            <a href="javascript:;"><div class="ys-phnav-header-font">Ngôn Ngữ</div></a>
                            <div class="ys-phnav-icon"></div>
                        </div>
    ...
    <div id="roi-modal-overlay" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,.55);backdrop-filter:blur(4px);align-items:center;justify-content:center;">
        <div style="position:relative;width:92%;max-width:1200px;max-height:90vh;overflow-y:auto;border-radius:16px;">
            <button id="roi-modal-close" style="position:absolute;top:12px;right:12px;z-index:99;width:36px;height:36px;border:none;border-radius:50%;background:rgba(0,0,0,.6);color:#fff;font-size:20px;cursor:pointer;display:flex;align-items:center;justify-content:center;line-height:1;">&times;</button>
        ...
        <div class="ys-cont1600">
            <div class="mod-foot-top">
                ...
                <div class="mod-foot-top-ri">
                    <ul class="mftr-ul"><li class="mftr-ul-li"><div class="mftr-ul-li-link"><a href="residential/residential-pv.html" title="" class="std-text2">Dân Dụng</a></div><ul><li><p><a href="residential/residential-pv.html">Điện Mặt Trời Dân Dụng</a></p></li><li><p><a href="residential/residential-ess.html">Lưu Trữ Năng Lượng Dân Dụng</a></p></li></ul></li><li class="mftr-ul-li"><div class="mftr-ul-li-link"><a href="business/business-pv.html" title="" class="std-text2">Doanh Nghiệp</a></div><ul><li><p><a href="business/business-pv.html">Điện Mặt Trời Doanh Nghiệp</a></p></li><li><p><a href="business/business-ess.html">Lưu Trữ Năng Lượng Doanh Nghiệp</a></p></li></ul></li><li class="mftr-ul-li"><div class="mftr-ul-li-link"><a href title="" class="std-text2">Sản Phẩm</a></div><ul><li><p><a href="product/pv-inverter.html" title="">Biến Tần</a></p></li><li><p><a href="product/battery-storage-system.html" title="">Hệ Thống Lưu Trữ Pin</a></p></li><li><p><a href="product/pv-module.html" title="">Tấm Pin Mặt Trời</a></p></li><li><p><a href="product/mounting-system.html" title="">Hệ Thống Lắp Đặt</a></p></li></ul></li><li class="mftr-ul-li"><div class="mftr-ul-li-link"><a href="resources-support/download/product-related.html" title="" class="std-text2">Tài Nguyên &amp; Hỗ Trợ</a></div><ul><li><p><a href="resources-support/download/product-related.html" title="">Tải Xuống</a></p></li><li><p><a href="resources-support/warranty.html" title="">Bảo Hành</a></p></li><li><p><a href="resources-support/faq/question-list.html" title="">Câu Hỏi Thường Gặp</a></p></li><li><p><a href="resources-support/community.html" title="">Cộng Đồng</a></p></li></ul></li><li class="mftr-ul-li"><div class="mftr-ul-li-link"><a href="news-media/news-center/news.html" title="" class="std-text2">Tin Tức &amp; Truyền Thông</a></div><ul><li><p><a href="news-media/news-center/media.html" title="">Đưa Tin Truyền Thông</a></p></li><li><p><a href="news-media/blogs.html" title="">Blog</a></p></li><li><p><a href="news-media/events.html" title="">Sự Kiện</a></p></li><li><p><a href="news-media/news-center/news.html" title="">Tin Tức</a></p></li></ul></li><li class="mftr-ul-li"><div class="mftr-ul-li-link"><a href="about-us.html" title="" class="std-text2">Về Chúng Tôi</a></div><ul><li><p><a href="partner.html" title="">Đối Tác</a></p></li><li><p><a href="cases/residentials.html" title="">Dự Án</a></p></li><li><p><a href="careers.html" title="">Tuyển Dụng</a></p></li></ul></li></ul>                </div>
            </div>
            <div class="mod-foot-min">
                <div class="footer-other-link">
                    <div class="std-text1 footer-other-link-name">Liên Kết</div>
                    ...
                    <div class="mfbr-input">
                        <input type="text" id="form2_email" name="form2_email" placeholder="Nhập email để đăng ký nhận tin mới nhất">
                    </div>
            ...
            <div class="mod-foot-bot">
                <div class="mod-foot-bot-le">
                    <!-- 版权信息 -->
                    <p><span>Bản quyền © 2025 Công ty TNHH Công nghệ Quang điện Skyworth Thâm Quyến.</span>  <a rel="nofollow" target="_blank" href="https://www.yongsy.com/">Powered by Yongsy</a> </p>
                </div>
                <ul class="mod-foot-bot-riul">
                    <li class="mfbr-li">
                        <a href="privacy.html" target="_self" title="Chính Sách Bảo Mật">Chính Sách Bảo Mật</a>
                    </li><li class="mfbr-li">
                        <a href="legal.html" target="_self" title="Thông Báo Pháp Lý">Thông Báo Pháp Lý</a>
                    </li><li class="mfbr-li">
                        <a href="sitemap.html" target="_self" title="Sơ Đồ Trang Web">Sơ Đồ Trang Web</a>
                    </li>                </ul>
            </div>
        </div>
    </div>   
