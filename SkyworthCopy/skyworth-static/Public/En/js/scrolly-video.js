var ScrollyVideo = function () {
    ...
    return class {
        constructor({
            ...
            this.isSafari = "WebKit" === m.name, c && this.isSafari && console.info("Safari browser detected"), this.currentTime = 0, this.targetTime = 0, this.canvas = null, this.context = null, this.frames = [], this.frameRate = 0;
            ...
            this.updateScrollPercentage = t => {
                ...
                this.debug && console.info("ScrollyVideo scrolled to", i), null == this.targetScrollPosition ? (this.setTargetTimePercent(i, {
                    jump: t
                }), this.onChange(i)) : h(this.targetScrollPosition) ? this.targetScrollPosition = null : o && null != this.targetScrollPosition && _()
            ...
            if (this.useWebCodecs)
                if (this.src) {
                    try {
                        ...
                        this.debug && console.error("Error encountered while decoding video", t), this.frames = [], this.video.load()
                    }
                    var t, e, i;
                    if (0 === this.frames.length) return this.debug && console.error("No frames were received from webCodecs"), void this.onReady();
                ...
                } else this.debug && console.warn("Cannot perform video decode: no `src` found");
            else this.debug && console.warn("Cannot perform video decode: `useWebCodes` disabled")
        }
        paintCanvasFrame(t) {
        ...
        setTargetTimePercent(t, e = {}) {
            const i = this.frames.length && this.frameRate ? this.frames.length / this.frameRate : this.video.duration;
        ...
        setScrollPercent(t) {
            ...
            h(r) ? this.targetScrollPosition = null : (window.scrollTo({
                top: r,
                behavior: "smooth"
